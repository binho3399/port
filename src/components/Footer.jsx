...
const Footer = () => {
    return (
        <footer className="text-white px-6 text-lg flex flex-col gap-16 2xl:py-6 py-4">
            ...
            <div className="container flex flex-col mx-auto justify-center 2xl:text-9xl xl:text-8xl lg:text-7xl md:text-6xl sm:text-5xl text-5xl font-black text-white">
                {/* <hr className=" border-gray-600" /> */}
                <h1 className="text-start">HO DAC</h1>  
                <h1 className="text-end">QUANG BINH</h1>
            </div>
            {/* <hr className=" border-gray-600" /> */}
            <div className="container flex mx-auto justify-between 2xl:text-lg md:text-base text-base text-white">
